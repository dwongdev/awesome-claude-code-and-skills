...
- [Skill Collections & Bundles](#skill-collections--bundles)
- [Subagents & Agent Definitions](#subagents--agent-definitions)
- [Multi-Agent Orchestrators](#multi-agent-orchestrators)
- [Plugins & Marketplaces](#plugins--marketplaces)
- [Hooks, CLI Tools & Utilities](#hooks-cli-tools--utilities)
- [CLAUDE.md Templates & Best Practices](#claudemd-templates--best-practices)
- [Cost Optimization & Token Management](#cost-optimization--token-management)
...
- [Skill Creation & Development](#skill-creation--development)
...
| 55 | [nulone/claude-rules-doctor](https://github.com/topics/claude-code) | CLI that detects dead `.claude/rules/` files by checking if `paths:` globs match actual files |
| 56 | [phiat/claude-esp](https://github.com/topics/claude-code) | Go TUI that streams Claude Code's hidden output (thinking, tool calls, subagents) to a separate terminal |
| 57 | [Niels Groeneveld/claude-tmux](https://github.com/topics/claude-code) | Manage Claude Code within tmux — popup switcher, status monitoring, git worktree support |
| 58 | [stravu/crystal](https://github.com/topics/claude-code) | Full desktop app for orchestrating, monitoring, and interacting with Claude Code agents |
| 59 | [Ishaan Sehgal/Omnara](https://github.com/topics/claude-code) | Command center syncing Claude Code sessions across terminal, web, and mobile |
| 60 | [ZENG3LD/Claude Session Restore](https://github.com/topics/claude-code) | Restore context from previous sessions — multi-factor data collection, time-based filtering |
| 61 | [eckardt/cchistory](https://github.com/topics/claude-code) | Shell history for Claude Code sessions — list all Bash commands Claude ran |
| 62 | [nyatinte/ccexp](https://github.com/topics/claude-code) | Interactive CLI for discovering and managing Claude Code config files and slash commands |
| 63 | [Brad S./cclogviewer](https://github.com/topics/claude-code) | Utility for viewing Claude Code `.jsonl` conversation files in a pretty HTML UI |
| 64 | [Jonas/run-claude-docker](https://github.com/topics/claude-code) | Self-contained Docker runner — forwards workspace with settings, auth, SSH agent, PGP |
| 65 | [Hal Shin/viwo-cli](https://github.com/topics/claude-code) | Run Claude Code in Docker with git worktrees — safe `--dangerously-skip-permissions` usage |
| 66 | [dyoshikawa/rulesync](https://github.com/topics/claude-code) | Node.js CLI — auto-generates and converts configs between Claude Code and other AI agents |
| 67 | [marcindulak/stt-mcp-server-linux](https://github.com/topics/claude-code) | Push-to-talk speech transcription for Linux — local Docker, no external API calls |
| 68 | [Mike Bailey/VoiceMode MCP](https://github.com/topics/claude-code) | Natural voice conversations in Claude Code |
...
| 89 | [prompt-security/clawsec](https://github.com/topics/claude-skills) | Security skill suite — drift detection, automated audits, skill integrity verification |
...
| 94 | [robzolkos/skill-rails-upgrade](https://github.com/topics/claude-skills) | Analyze Rails apps and provide upgrade assessments |
...
| 102 | [AgriciDaniel/claude-seo](https://github.com/topics/claude-skills) | SEO workflow collection — technical SEO, hreflang, sitemap, schema, programmatic SEO |

## Learning Resources & Guides

| # | Repo | Description |
|---|------|-------------|
| 103 | [Rudolf Schmidt/The Agentic Startup](https://github.com/topics/claude-code) | Comprehensive agents, commands, and output styles for shipping production code |
| 104 | [Vlad Goncharov/Context Engineering Kit](https://github.com/topics/claude-code) | Advanced context engineering techniques with minimal token footprint |
| 105 | [EveryInc/Compound Engineering Plugin](https://github.com/topics/claude-code) | Agents, skills, and commands turning past mistakes into lessons for future improvement |
| 106 | [TÂCHES Claude Code Resources](https://github.com/topics/claude-code) | Balanced subagents, skills, commands — skill-auditor, hook creation, adaptable meta-skills |
| 107 | [ThibautMelen/Agentic Workflow Patterns](https://github.com/topics/claude-code) | Patterns from Anthropic docs — subagent orchestration, parallel tool calling, wizard workflows with Mermaid diagrams |
| 108 | [Paul/Claude Code Agents (UndeadList)](https://github.com/topics/claude-code) | E2E development workflow for solo devs — parallel auditors, micro-checkpoint protocols |
| 109 | [Eric Buess/Claude Code Documentation Mirror](https://github.com/topics/claude-code) | Mirror of Anthropic docs, updated every few hours |
| 110 | [Vibe-Log](https://github.com/topics/claude-code) | Analyzes prompts locally, provides strategic guidance — statusline integration + HTML reports |

## Skill Creation & Development
...
| 115 | [Peter Steinberger/Claude Code as MCP server](https://github.com/topics/claude-code) | Run Claude Code as a one-shot MCP server — an agent inside your agent |
| 116 | [SuperClaude-Org/SuperClaude](https://github.com/topics/claude-code) | Configuration framework with specialized commands, cognitive personas, and development methodologies |
| 117 | [Piebald-AI/tweakcc](https://github.com/topics/claude-code) | Command-line tool to customize your Claude Code styling |
...
git clone https://github.com/<repo> ~/.claude/skills/<name>
...
# Claude Code auto-detects agents on startup
```

## Contributing

Found a repo that should be on this list? Open a PR or create an issue!

---

**Disclaimer:** Skills and plugins can execute arbitrary code. Always review source code before installing. Only use skills from trusted sources.
